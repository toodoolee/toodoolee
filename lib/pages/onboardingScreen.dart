      ...
      body: OverBoard(
        ...
        skipCallback: () {
          ...
          settingsBox.put("dailyNotifications",
              true); //set the daily notifications be true, with this you can get daily notifications for writing the Toodoolee, so to create a Habit,
        ...
        finishCallback: () {
          ...
          //set the daily notifications be true, with this you can get daily notifications for writing the Toodoolee, so to create a Habit,
          setDailyReminderMethod([
            6,
            30
          ], context); // as in the start the Daily Notifications will have null as the value, so default is 6:30 when the daily alarm will ring (you can change time from settings Page inside the app)
