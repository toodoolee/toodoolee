...
import 'package:toodo/uis/Toodoolee Lists/WorkingOnPage.dart';
import 'package:toodo/uis/Toodoolee Lists/completedListUi.dart';
...
import 'uis/Toodoolee Lists/CompletedPage.dart';
  ...
  AwesomeNotifications().initialize(
    ...
    [
      NotificationChannel(
        ...
        channelDescription:
            'Sends you daily notifications to remind you to write Toodoolees, to win the day',
        onlyAlertOnce: true,
...
/* ---------------------------------------- 
This is the Splash Screen, This Just Shows the Toodoolee Logo at the Starting of the App...
            ...
            return AdaptiveTheme(
              light: ThemeData(
                ...
                timePickerTheme: TimePickerThemeData(
                    ...
                    dialBackgroundColor: Color(0xFFFCFFA6),
                    dialHandColor: Color(0xFF64C9CF),
                    dialTextColor: Color(0xff4785FF),
              ...
              dark: ThemeData(
                ...
                timePickerTheme: TimePickerThemeData(
                    backgroundColor: Color(0xFF64C9CF),
                    dialBackgroundColor: Color(0xFFFFE459),
                    dialHandColor: Color(0xFF64C9CF),
                    dialTextColor: Color(0xff4785FF),
                    hourMinuteTextStyle: TextStyle(
...
This is the Method/Function checks wheather the today's date, month's first day and it predicts weather to reset-up the Toodoolee or not 
*/
    resetToodooleeMidNight(context); // this method is in processes.dart
        ...
        child: Column(
          ...
          children: [
            FadeInUpBig(
              ...
              child: Center(
                child: Image.asset(
                  "icon/logo.png", // the image that is shown in the splash Screeeeeeen
...
Do you noticed?
Here in Toodoolee, the Bottom Navigation Bar is constant, In Toodoolee, the Floating Action Button is also constant, It means they are presented in every Screen, 
...
If something is deleted then count will be Zero (streaks or Toodoolee whatever added.)
        ...
        builder: (context, remainingTodoCount, _) {
          ...
          return Scaffold(
            appBar: AppBar(
                ...
                // And else it is not the settingsPage, Let the Title of the Toodoolee's App Bar be "Toodoolee"
                title: _selectedItemPosition == 2
                    ...
                    : Text(
                        ...
                        style: TextStyle(
                            fontWeight: FontWeight.w700,
                            color: Theme.of(context)
                                .accentColor), //if the more page is opened or Main Page, i.e where streka , Tooodolee or completed one rests then then the title will be, "Toodoolee"
                      )),
            ...
            floatingActionButton: Visibility(
              ...
              // as the use can add only 10 toodooless, not more if the Toodoolees is 10 then for blocking more items,
...
# How much more Toodoolees can be Added (limits)
*/
...
// when something is added to the Toodoolee or removed etc, totalTodoCund will be affected.
// Take a look at totalTodoCount by clicking on it with control or command Pressed.
// when something is added to the Toodoolee or removed etc, totalTodoCount will be affected.
// Take a look at totalTodoCount by clicking on it with control or command Pressed.
    return ValueListenableBuilder<int>(
        valueListenable: totalTodoCount,
        builder: (context, remainingTodoCount, _) {
 ...
 */
                  ...
                  // It is that Fancy page, at the start that encorouges you to add Toodoolee for the Today,
...
Like if the Toodoolee remaining is 10 hide the counter,
