...
*/
resetToodooleeMidNight(context) {
  ...
  and because the Toodoolee checks the dates sequence wise, if today is 15 the next should be 16 and if it is 16 then the next day must be  17, 
  if it is then Toodoolee will be resetted, and suppose it's 30th of April today and next day is 1st of May.  
...
Works similar to the resetToodooleeMidnight() Method also the Template is also identical.
